...
var advertisementRegistrarContract = web3.eth.contract([
  {
    "constant": false,
    "inputs": [
      {
  ...
  },
  {
    ...
    "name": "startAdvertisementsAndBid",
    "outputs": [],
    "payable": true,
    "type": "function"
  },
...
var ethRegistrar = advertisementRegistrarContract.at(ens.owner(namehash('eth')));
