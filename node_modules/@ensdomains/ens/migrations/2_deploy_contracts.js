 ...
 */
function deployAdvertisementRegistrar(deployer, tld) {
  var rootNode = getRootNodeFromTLD(tld);
  ...
  deployer.deploy(ENS)
    .then(() => {
      ...
      // The last argument `0` specifies the advertisement start date to `now`
...
module.exports = function(deployer, network) {
  ...
  else if (network === 'dev.advertisement') {
    deployAdvertisementRegistrar(deployer, tld);
  }
