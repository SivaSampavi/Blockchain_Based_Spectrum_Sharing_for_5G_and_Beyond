...
interface Registrar {
    ...
    enum Mode { Open, Advertisement, Owned, Forbidden, Reveal, NotYetAvailable }

    event AdvertisementStarted(bytes32 indexed hash, uint registrationDate);
    ...
    function finalizeAdvertisement(bytes32 _hash) external;
